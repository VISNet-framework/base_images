...
| `Dockerfile_py312_cuda126_cudnn9_onnx_ubuntu24` | 3.12 | 12.6 | - | 9 | - | Yes | 24 | Deploy-oriented image, without torch|
...
# only Docker files matching following regex will be build
```bash
printf '%s
